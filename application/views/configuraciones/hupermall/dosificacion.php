<div id="tab-<?=$id?>"> 
      ...
      <div id="opciones-hupermall">

          <ul>
              <li><a href="#opcion-2-hupermall<?=$id?>"> Impresion </a></li>
              <li><a href="#opcion-4-hupermall<?=$id?>"> Mensajes </a></li>
          </ul>
    
         
          <div id="opcion-2-hupermall<?=$id?>">
             <?php echo $this->load->view('configuraciones/hupermall/impresion', null, TRUE);?> 
          </div>
         

			 <div id="opcion-4-hupermall<?=$id?>"> 
      ...
      <script>
        ...
        $('#opciones-hupermall').responsiveTabs({
	 ...
	 function message_hupermall(id) {
		...
		$.post("<?=site_url('set-message-hupermall')?>", {id:id, factura:factura, recibo:recibo, comanda:comanda })
			.done(function( data ) {
