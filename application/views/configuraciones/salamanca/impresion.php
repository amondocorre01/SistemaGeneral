<div class="row">
   <div class="col-3">
      <input class="form-control" type="number" name="num_comandas" id="num_comandas_salamanca" onchange="ocultar($(this).val())" min="1" max="4" step="1">
   </div>
</div>
...
function elegir(cadena) {
   ...
   $.post('<?=site_url('comanda-pando')?>', {categoria:categoria, valor:valor})
