...
define('APIKEY', 'TokenApi');
define('URL_SINCRONIZACION', 'https://pilotosiatservicios.impuestos.gob.bo/v2/FacturacionSincronizacion?wsdl');
define('URL_RECEPCION_COMPRAS', 'https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioRecepcionCompras?wsdl');
define('URL_OPERACIONES', 'https://pilotosiatservicios.impuestos.gob.bo/v2/FacturacionOperaciones?wsdl');
define('URL_CODIGOS', 'https://pilotosiatservicios.impuestos.gob.bo/v2/FacturacionCodigos?wsdl');
define('URL_COMPRA_VENTA', 'https://pilotosiatservicios.impuestos.gob.bo/v2/ServicioFacturacionCompraVenta?wsdl');
