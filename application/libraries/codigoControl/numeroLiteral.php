...
http://www.capressocafe.com/facturacion/numeroLiteral.php?monto=123

@variables

monto: 148    // el monto no debe exeder a los 999999999 y tiene que ser un numero entero


@return
literal: ciento cuerneta y ocho
*/
?>
...
<?php
  ...
  function decenas($n) {
    ...
    if ( $x == 0 ) {
    return $decenas[$n];
    } else return $decenas[$n - $x].' con '. basico($x);
  }
