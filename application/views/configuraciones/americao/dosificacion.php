<div id="tab-<?=$id?>"> 
      ...
      <div id="opciones-americao">

          <ul>
              <li><a href="#opcion-2-americao<?=$id?>"> Impresion </a></li>
              <li><a href="#opcion-4-americao<?=$id?>"> Mensajes </a></li>
          </ul>
    
         
          <div id="opcion-2-americao<?=$id?>">
             <?php echo $this->load->view('configuraciones/americao/impresion', null, TRUE);?> 
          </div>
         

			 <div id="opcion-4-americao<?=$id?>"> 
      ...
      <script>
        ...
        $('#opciones-americao').responsiveTabs({
            startCollapsed: 'accordion'
        });

        var show_update = 0;

	 function message_americao(id) {
