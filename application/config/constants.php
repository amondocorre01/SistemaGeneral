...
define('URL_SINCRONIZACION', 'https://siatrest.impuestos.gob.bo/v2/FacturacionSincronizacion?wsdl');
define('URL_RECEPCION_COMPRAS', 'https://siatrest.impuestos.gob.bo/v2/ServicioRecepcionCompras?wsdl');
define('URL_OPERACIONES', 'https://siatrest.impuestos.gob.bo/v2/FacturacionOperaciones?wsdl');
define('URL_CODIGOS', 'https://siatrest.impuestos.gob.bo/v2/FacturacionCodigos?wsdl');
define('URL_COMPRA_VENTA', 'https://siatrest.impuestos.gob.bo/v2/ServicioFacturacionCompraVenta?wsdl');
define('URL_QR', 'https://siat.impuestos.gob.bo/consulta/QR');
