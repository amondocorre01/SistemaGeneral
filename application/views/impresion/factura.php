...
$pdf->SetFont('helvetica', 'B', 9);
$pdf->MultiCell(122, 30,  'Son: '.ucfirst(($factura->datos_factura->literal)).' '.$factura->datos_factura->fraccion.'/100 Bolivianos', 0, 'L', 0, 1, $x, $y, true, 0, false, true, 10, 'M', true);
...
$tipo_emision = $factura->datos_factura->tipo_emision;
/*
if($tipo_emision != '1'){
    $pdf->Output(NAME_DIR.'assets/facturas/pdf/'.$numero_factura.'.pdf', 'F');
}*/
$ver_pdf_carta = $factura->datos_factura->ver_pdf_carta;
