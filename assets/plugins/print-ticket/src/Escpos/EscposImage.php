    ...
    public static function load(
        ...
        foreach ($preferred as $implemetnation) {
            if ($implemetnation === 'imagick') {
                ...
                return new \Escpos\ImagickEscposImage($filename, $allowOptimisations);
            } elseif ($implemetnation === 'gd') {
                if (!self::isGdLoaded()) {
                    // Skip option if GD not loaded
                    continue;
                }
                return new \Escpos\GdEscposImage($filename, $allowOptimisations);
                ...
                return new \Escpos\NativeEscposImage($filename, $allowOptimisations);
            } else {
