<?php
   ...
   class Americae extends CI_Controller {
   
      public function index()
      {
         $DB2 = $this->load->database('aeste', TRUE);
         
         $sql = 'EXEC SAE_GET_DOSIFICACION';
      ...
      {  
         ...
         $sql = "EXEC SAE_UPDATE_DOSIFICACION ".$id.",".$estado;
         $res = $DB2->query($sql);
      ...
      {  
         ...
         $sql = "DELETE FROM IMPRESION_SAE WHERE ID_CATEGORIA= $categoria";
         $DB2->query($sql);

         $sql_2 = "INSERT INTO IMPRESION_SAE(ID_CATEGORIA, COMANDA_$valor) VALUES ($categoria, 1)";
         $DB2->query($sql_2);
