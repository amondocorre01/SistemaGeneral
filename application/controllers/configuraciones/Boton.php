<?php
   ...
   class Boton extends CI_Controller {
      ...
      public function sucursal() {
         ...
         $campos = "nlp.ID_NOMBRE_LISTA_PRECIOS, NOMBRE_LISTA_PRECIOS AS CANAL, lvs.ID_VENTAS_LISTA_VENTA_SUCURSAL AS ID, TRANSPORTE, ENVIO_PROGRAMADO, DESCUENTO_FACTURADO, DESCUENTO_TRADICIONAL";
