...
class Pedidoextraordinario extends CI_Controller {
    ...
    {   
        ...
        if(guardarPedidoExtraordinario($codigo_sucursal, $sufijo_sucursal, $categoria_1, $categoria_2, $producto_madre, $modificara_producto, $detalle_producto, $id_usuario, $fecha_registro)){
            echo json_encode('ok');
        }else{
